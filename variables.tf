...
EOT
  ...
  # --- Unconfirmed validation candidates, derived from azurerm_maintenance_assignment_virtual_machine's provider source ---
  ...
  #   source:    [from virtualmachines.ValidateVirtualMachineID] !ok
  # path: virtual_machine_id
  #   source:    [from virtualmachines.ValidateVirtualMachineID] err != nil
}
